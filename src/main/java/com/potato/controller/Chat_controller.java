...
public class Chat_controller {
	...
	public void chat_list(Model model,HttpSession session) {
		...
		MemberService m_service = null; //상대방 프로빌 불러오는 service
