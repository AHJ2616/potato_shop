	...
	<div class="product-details">
		...
		<div class="form-group">
			...
			<form id="interestForm">
				<input type="hidden" id="member_number2" name="member_number2" value="<c:out value="${ sessionScope.member_number }"/>" />
				<input type="hidden" id="board_number2" name="board_number2"	value="<c:out value="${ board.board_number }"/>" />
