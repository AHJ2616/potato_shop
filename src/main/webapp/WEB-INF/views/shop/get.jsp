...
<body>
    ...
    <div class="product-image">
        <img id="productImage" src="${pageContext.request.contextPath}/resources/images/${board.photo_name}" alt="Product Image">
    </div>
    <div class="form-group">
        <input class="form-control" name="title" value='<c:out value="${ board.title }"/>' readonly="readonly" />
    </div>
    <div class="form-group">
    	<input class="form-control" name="address" value='<c:out value="${board.board_address}"/>' readonly="readonly" />
    </div>
    <div class="form-group">
        <input class="form-control" name="status" value='<c:out value="${ board.status }"/>' readonly="readonly" />
    </div>
    <div class="form-group">
        <input class="form-control" name="content" value='<c:out value="${ board.content }"/>' readonly="readonly" />
    </div>
    <div class="form-group">
        <input class="form-control" name="price" value='<c:out value="${ board.price }"/>' readonly="readonly" />
    </div>
    <div class="form-group">
	    <span>
	        <form id="likeForm">
	    ...
	    <span id="views" style="margin-right: 5px;">
	    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16" style="margin-right: 10px;">
	  		<path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/>
	  		<path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
			</svg>
	    <c:out value="${ board.views }" /></span>
    </div>
    ...
    <c:choose>
    	...
    	<c:otherwise>
    		<button id="contactSeller" type="button" class="btn btn-warning" onclick="location.href='${pageContext.request.contextPath}/potato/chat?reciever=${board.writer_number}'">대화연결</button>
    		<button id="listBtn" type="button" class="btn btn-info">리스트</button>
    	</c:otherwise>
    </c:choose>
    </form>
