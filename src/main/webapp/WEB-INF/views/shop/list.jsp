...
<link rel="stylesheet" href="/resources/css/shop_list.css">
  <!-- shop section -->
...
<section class="shop_section layout_padding">
    ...
    <div class="row">
        ...
        <c:forEach items="${list}" var="boardlist">
         ...
         <div id="board-list"> <!-- 더 보기 에서 불러온 페이지 출력용 -->
    	</div>
	 <div class="text-center mt-4">
         <a href="#" id="load-more" class="btn-link" data-page="2">더 보기</a>
    </div>
</section>
    	 ...
    	 $.each(boards, function(index, board) {
            ...
            let boardHtml = `
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                    <div class="box">
                        <a href="/shop/get?board_number=${board_number}">
                            <div class="img-box">
                                <img src="${pageContext.request.contextPath}/resources/upload/${photo_name}" alt="">
                            </div>
                            <div class="detail-box" align="center">
                                <h6>${title}</h6>
                            </div>
                            ...
                            <div class="card_address">${board_address}</div>
                            ...
                            <div class="regidate"><fmt:formatDate pattern="yyyy-MM-dd" value="${regidate}" /></div>
                        </a>
                    </div>
                </div>
            `;
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.length > 0) {
                    appendBoards(response);  // 여기서 appendBoards 함수를 호출합니다.
